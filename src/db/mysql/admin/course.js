    ...
    try {
      ...
      db.query(
        ...
        [
          ...
          JSON.stringify(courseData.aims),
          JSON.stringify(courseData.who_should_attend),
          JSON.stringify(courseData.objectives_point),
          JSON.stringify(courseData.what_you_will_learn_point),
