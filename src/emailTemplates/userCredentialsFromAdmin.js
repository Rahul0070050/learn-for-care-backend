export function userCredentialsFromAdmin(name, email, pass) {
  return `
<!DOCTYPE html>
<html
  lang="en"
                ...
                <tr>
                  ...
                  >
                    <div class="text">
                      ...
                      <p style="font-weight: 600">Use this credentials to sign up</p>
                    </div>
                  </td>
                </tr>
                <tr>
                  <td style="text-align: center">
                    <div style="text-align: start; margin: 0 2rem;">
                      ...
                      <p style="font-weight: 600; color: ''">
                        Welcome to our learning platform! We've created your account with the following details:
                        <br />
                      </p>
                      <span>
                        Email: <span style="color: black;">${email}</span><br />
                        Password: <span style="color: black;">${pass}</span>
                      </span>
                      <br />
